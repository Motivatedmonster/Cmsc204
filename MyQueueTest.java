...
public class MyQueueTest {
	...
	public void testDequeueStudent() {
		...
		try {
			...
			assertTrue("Correctly thrown", true);
		}catch(Exception e) {
			assertTrue("General exception thrown", false);
		}
	...
	public void testEnqueueStudent() {
		...
		try {
	        ...
	        assertEquals(true, doubleQ.enqueue(2.8));
	        assertEquals(true, doubleQ.enqueue(1.4));
	        assertEquals(true, doubleQ.enqueue(8.5));
	        assertEquals(true, doubleQ.enqueue(1.0));
	        assertEquals(true, doubleQ.enqueue(3.6));
	        doubleQ.enqueue(0.5);
		}catch (QueueOverflowException e) {
			assertTrue("Correctly thrown", true);
		}catch(Exception e) {
	...
	public void testToStringStudent() throws QueueOverflowException {
		doubleQ = new MyQueue<>(5);
		  ...
		  doubleQ.enqueue(3.1);
		    doubleQ.enqueue(6.2);
		    assertEquals("3.1 6.2", doubleQ.toString());
